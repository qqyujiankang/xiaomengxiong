...
public final class ToastUtils {
    ...
    private static int sYOffset    = (int) (64 * Utils.getApp().getResources().getDisplayMetrics().density + 0.5);
    private static int sBgColor    = COLOR_DEFAULT;
    private static int sBgResource = R.drawable.xml_toast;
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                ...
                View v = inflate.inflate(R.layout.public_toast_me, null);
