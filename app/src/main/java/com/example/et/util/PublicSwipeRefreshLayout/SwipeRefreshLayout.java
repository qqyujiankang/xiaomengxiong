package com.example.et.util.PublicSwipeRefreshLayout;
...
//=======================================================================================================================
        mFooterView = View.inflate(context, R.layout.public_swipe_refresh_view_footer, null);
        setColorSchemeResources(android.R.color.holo_blue_bright, android.R.color.holo_green_light, android.R.color.holo_orange_light);
    }
...
/**/
    ...
    /**
     * Set a callbacka to override {@link SwipeRefreshLayout#canChildScrollUp()} method. Non-null
     * callbacka will return the value provided by the callbacka and ignore all internal logic.
     *
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsBeingDragged) {
                     ...
                     *
                     * */
                    if (overscrollTop > 0 && !isLoading()) {//--------------当加载更多正在执行时，不允许执行刷新下事件，（出现动画效果）
    ...
    public interface OnChildScrollUpCallback {
         ...
         *
         * @param parent SwipeRefreshLayout that this callbacka is overriding.
...
//----------------------------------------------------------
    ...
    private boolean canLoadMore() {
        // 1. 是上拉状态,也就是刷新数据
        boolean condition1 = (mDownY - mUpY) >= mTouchSlop;

        //  Log.i("exp", "mDownY==="+mDownY+"====mUpY===="+mUpY+"===========mTouchSlop===="+mTouchSlop+"=====是上拉状态======" + condition1);
        if (condition1) {
            Log.d(TAG, "------->  是上拉状态");
            //  return false;
        ...
        Log.i("exp", "condition1=======" + condition1 + "     condition2===============" + condition2 + "     condition3================" + condition3 + "         isRefreshing()=====" + isRefreshing());
        return condition1 && condition2 && condition3 && !isRefreshing();
    }
    ...
    private void loadData() {
        if (onLoadMoreListener != null&&!isRefreshing()) {
            // 设置加载状态，让布局显示出来
            setLoading(true);
    ...
    private void setRecyclerViewOnScroll() {
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                // 移动过程中判断时候能下拉加载更多
                Log.i("exp", "=====setRecyclerViewOnScroll=================");
