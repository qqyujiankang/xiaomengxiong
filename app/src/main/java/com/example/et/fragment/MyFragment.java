...
public class MyFragment extends BaseFragment {
    ...
    @OnClick({R.id.Rl_Record,
            R.id.Ll_Friends_share, R.id.ll_my_team, R.id.Rl__Node_returns, R.id.ll_gain_recording, R.id.Ll_USDT_address_binding, R.id.ll_set_password, R.id.ll_feedback, R.id.ll_version_information, R.id.public_button})
