...
public final class DeviceUtils {
     ...
     * 获取设备 cup。
     *
     * @return the cup of device's system
     */
    public static String getDeviceCup() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP? Build.SUPPORTED_ABIS[0]: Build.CPU_ABI;
    }
